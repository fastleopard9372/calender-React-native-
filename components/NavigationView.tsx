    ...
    return (
        <View style={[styles.container, styles.navigationContainer]}>
            <View style={styles.navContainer}>
                ...
                <Divider />
                <Menu.Item onPress={() => {}} title={ENCHINTL["header"]["nav-bar"]["calendar"][intl]} />
                <Menu.Item onPress={() => {}} title={ENCHINTL["header"]["nav-bar"]["note"][intl]} />
                <Menu.Item onPress={() => {}} title={ENCHINTL["header"]["nav-bar"]["library"][intl]} />
                <Menu.Item onPress={() => {}} title={ENCHINTL["header"]["nav-bar"]["workspace"][intl]} />
                <Divider />
