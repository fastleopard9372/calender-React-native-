...
import { View, StyleSheet, PanResponder, DrawerLayoutAndroid } from "react-native";
import { PaperProvider, FAB, MD3Colors } from "react-native-paper";
...
const Calender = () => {
    ...
    return (
        <View
            style={{ position: "absolute", top: 80, height: "90%", flex: 1, width: "100%" }}
    ...
    return (
        ...
        >
            <View style={{ flex: 1, flexDirection: "column", alignItems: "stretch", justifyContent: "space-between" }}>
                <Header handleDrawer={() => drawer.current?.openDrawer()} />
                <Calender />
            </View>
        </DrawerLayoutAndroid>
    );
